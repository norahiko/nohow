...
exports.runMain = function runMain(mainTasks, doneAllTasks) {
    exports.addAsyncTask('--before', Task.beforeTaskList);
    exports.addAsyncTask('--main', ['--before'].concat(mainTasks));
    exports.addAsyncTask('--after', Task.afterTaskList);
    ...
    Task.get('--main').start(function(mainTaskError) {
        Task.get('--after').start(function(afterTaskError) {
...
exports.addBuiltinTask = function() {
    ...
    exports.addTask('--save-configfiles', function() {
