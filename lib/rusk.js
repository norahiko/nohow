...
rusk.expandFilter = rusk.commands._expandFilter;
rusk.reservedValue = rusk.commands._reservedValue;
...
for(var commandName in rusk.commands) {
    if(commandName[0] !== '_') {
        rusk[commandName] = rusk.commands[commandName];
    }
}
