...
// Nohow uses lazy loaded libraries
// it makes startup faster
helper.lazylib = { nohow: module.parent.exports };

setLazyLib(helper.lazylib, "tools", "./tools.js");
setLazyLib(helper.lazylib, "logging", "./logging.js");
setLazyLib(helper.lazylib, "taskModule", "./task.js");
setLazyLib(helper.lazylib, "tempdir", "./tempdir.js");
setLazyLib(helper.lazylib, "commandLine", "./command_line.js");
setLazyLib(helper.lazylib, "Watcher", "./watcher.js");
setLazyLib(helper.lazylib, "globy", "globy");
...
helper.wrapEventEmitter = function(obj) {
    var EventEmitter = require("events").EventEmitter;
    EventEmitter.call(obj);
    for(var name in EventEmitter.prototype) {
        obj[name] = EventEmitter.prototype[name];
    }
};
