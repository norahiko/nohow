...
CommandLine.prototype.printTasks = function(printBuiltinTasks) {
    if(printBuiltinTasks) {
        this.printTasksByMode("Builtin task", taskModule.Task.BUILTIN);
        this.printTasksByMode("Plugin task", taskModule.Task.PLUGIN);
    }
    this.printTasksByMode("User task", taskModule.Task.USER);
};
