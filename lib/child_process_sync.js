...
exports.exec = function exec(cmd, options) {
    var result = exports.popen(cmd, options);
...
exports.popen = function popen(cmd, options) {
    var proc = createShellProcess(cmd, options);
    proc.stdio = "pipe";
...
function createShellProcess(cmd, options) {
